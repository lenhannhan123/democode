...
<div class="card card-primary">
  ...
  <!-- /.card-header -->
  <!-- form start -->
  <form role="form" action="{{url("admin/user/create/createbook")}}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="card-body">
      <div class="form-group">
        <label for="input-group-text">Tên người dùng</label>
        <input type="text" class="form-control" id="input-group-text" name="username" placeholder="Nhập Tên người dùng">
      </div>
      <div class="form-group">
        <label for="input-group-text">Mật khẩu</label>
        <input type="password" class="form-control" id="input-group-text" name="password" placeholder="Nhập Mật khẩu">
      </div>
      <div class="form-group">
