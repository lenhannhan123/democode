...
#!perl
#line 29
    eval 'exec C:\Users\Thanh Nhan\Documents\GitHub\democode\XAMPP\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'C:\Users\Thanh Nhan\Documents\GitHub\democode\XAMPP\perl\bin\perl.exe';
